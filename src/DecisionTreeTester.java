...
public class DecisionTreeTester<G extends ITreeGenerator<D>, D extends IDataset> {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Dataset trainingData = makeDataset(CANDIDATES_TRAINING_GENDER_EQUAL, Dataset.class);
            double accuracy =
                    tester.getDecisionTreeAccuracy(trainingData, trainingData, "hired");
            System.out.println("Accuracy on training data: " + accuracy);

            int numIters = 100;
            Dataset testingData = makeDataset(CANDIDATES_TESTING, Dataset.class);
            accuracy = tester.getAverageDecisionTreeAccuracy(trainingData, testingData, "hired", numIters);
